      ...
      <Reveal className="mx-auto w-[90%]">
        ...
        >
          <Image
            ...
            width={301}
            height={360}
            className="h-[clamp(2.5rem,6.18vw,7.75rem)] w-auto"
          />

          <h2 className="mt-[clamp(0.75rem,2.9vw,3.6rem)] text-[clamp(1.375rem,3.4vw,4.25rem)] leading-[1.15] font-bold tracking-[-0.02em] text-white">
            Hollywood takes 10 years to build an IP.
            <br />
            We take 10 weeks.
          </h2>

          <p className="mt-[clamp(0.75rem,4.4vw,5.5rem)] text-[clamp(1rem,2.78vw,3.5rem)] leading-[1.2] text-white">
